...
public class ValueAnomalyServiceImplTest {
  private static final Double[] anomalyData = new Double[] {
      100.0, 101.0, 102.0, 104.0, 126.0, 108.0, 112.0,
      113.0, 114.0, 116.0, 118.0, 100.0, 124.0, 126.0, Double.NaN
  };
  private static final Double[] repairedData = new Double[] {
      100.0, 101.0, 102.0, 104.0, 106.0, 108.0, 112.0,
      113.0, 114.0, 116.0, 118.0, 120.0, 124.0, 126.0, 128.0
  };
