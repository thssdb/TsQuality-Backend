...
public class ValueAnomalyServiceImpl implements ValueAnomalyService {
  ...
  @Override
  public ValueAnomalyResultDto anomalyDetectionAndRepairWithScreen(String path, Double minSpeed, Double maxSpeed, String timeFilter) {
    ValueRepairUDF udf = new ValueRepairUDF(Map.of("minSpeed", minSpeed, "maxSpeed", maxSpeed));
    return anomalyDetectionAndRepair(path, udf, timeFilter);
  }

  @Override
  public ValueAnomalyResultDto anomalyDetectionAndRepairWithLsGreedy(String path, Double center, Double sigma, String timeFilter) {
    ValueRepairUDF udf = new ValueRepairUDF(Map.of("center", center, "sigma", sigma));
    return anomalyDetectionAndRepair(path, udf, timeFilter);
  }

  private ValueAnomalyResultDto anomalyDetectionAndRepair(String path, ValueRepairUDF udf, String timeFilter) {
