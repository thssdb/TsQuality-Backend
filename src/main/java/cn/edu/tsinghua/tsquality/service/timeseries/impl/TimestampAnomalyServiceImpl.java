...
public class TimestampAnomalyServiceImpl implements TimestampAnomalyService {
  ...
  @Override
  public TimestampAnomalyResponseDto anomalyDetectionAndRepair(TimestampAnomalyRequestDto request) {
    if (request.getInterval() != null) {
      return anomalyDetectionAndRepair(
          request.getPath(), request.getInterval(), request.getTimeFilter());
    }
    if (request.getMethod() != null) {
      return anomalyDetectionAndRepair(
          request.getPath(), request.getMethod(), request.getTimeFilter());
    }
