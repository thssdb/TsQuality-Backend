...
public class TsFileStat {
    ...
    private final SeriesStat fileStat = new SeriesStat();
    private final List<SeriesStat> chunkStats = new ArrayList<>();
    private final List<List<SeriesStat>> pageStats = new ArrayList<>();
